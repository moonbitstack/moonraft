...
// interface `moon info` emits, backed by the 723-test suite. Because `moon doc`
...
<html lang="en">
  <head>
    ...
    <title>API · moonraft</title>
    <meta name="description" content="The public API of moonraft, generated from the authoritative .mbti interface — ${typeCount} types, ${methodCount} methods, ${fnCount} free functions, all backed by 723 tests." />
  ...
  <body>
    <header class="topbar"><div class="wrap row">
      <a class="brand" href="./"><span class="prompt">~/</span>moonraft<span class="caret">▊</span></a>
      <nav class="links">
    ...
    <main class="wrap">
      <section class="hero" style="padding:56px 0 24px">
        ...
        <p class="lede" style="font-size:16px">
          ...
          <code>moon info</code> emits and the 723-test suite pins.
    ...
    <footer class="site"><div class="wrap row">
      ...
      <span class="mono">© 2026 Leo Cheng · <a href="https://github.com/moonbitstack/moonraft">GitHub</a></span>
    </div></footer>
