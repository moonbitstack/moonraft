...
<html lang="en">
  <head>
    ...
    <meta name="description" content="The public API of moonraft, generated from the authoritative .mbti interface — ${typeCount} types, ${methodCount} methods, ${fnCount} free functions, all backed by 708 tests." />
